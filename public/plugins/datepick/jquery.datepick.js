...
function Datepicker() {
	this._defaults = {
		...
		yearRange: 'c-25:c+25', // Range of years to show in drop-down: 'any' for direct text entry
	...
	this.regional[''] = { // US/English
		...
		todayStatus: 'Xem ngày hôm nay', // Status text for the today's month command
		//clearText: 'Xóa', // Text for the clear command
		//clearStatus: 'Xóa ngày đã chọn', // Status text for the clear command
		...
		weekText: 'Tuần', // Text for week of the year column header
		weekStatus: 'Tuần trong năm', // Status text for week of the year column header
		dayStatus: 'Chọn DD, d  M, yyyy', // Status text for selectable days
		defaultStatus: 'Hãy chọn ngày', // Status text shown by default
